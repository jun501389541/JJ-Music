...
export const SETTINGS_PAGES: Record<string, SettingsPage> = {
  ...
  search: { title: '搜索', icon: 'search', description: '全局搜索页在你输入之前显示什么', items: [
    ...
    toggle('显示热门搜索词', 'showSearchHotWords', '向平台问一次"现在大家在搜什么"：当前页签显示那一家的热搜榜（约 20 条），「全部」把四家轮流并起来（上限 48）。每家每个自然日只问一次，结果留在本地，重启也算今天问过；跨过零点那次先显示昨天的、后台再换。QQ、网易云、酷我、酷狗都有公开端点，咪咕没有——那一家的页签里这一栏不出现。汇总时鼠标停在词条上会显示它是哪家给的')
  ] },
